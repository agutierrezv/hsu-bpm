...
angular.module('myApp', ['ngRoute', 'ngCookies', 'ui.bootstrap', 'textAngular'])
	.config(['$routeProvider', function ($routeProvider) {
		$routeProvider
			...
			.when('/tramite/',		 { templateUrl: 'views/tramite/list.html',   controller: 'ListTramiteController' })
			.when('/tramite/select',		 { templateUrl: 'views/tramite/select.html',   controller: 'SelectTramiteController' })
			.when('/tramite/add',        { templateUrl: 'views/tramite/edit.html',   controller: 'EditTramiteController' })
			.when('/tramite/edit/:id', 	 { templateUrl: 'views/tramite/edit.html',   controller: 'EditTramiteController' })
			.when('/tramite/delete/:id', { templateUrl: 'views/tramite/delete.html', controller: 'DeleteTramiteController' })
			.when('/tramite/:id', { templateUrl: 'views/tramite/view.html', controller: 'ViewTramiteController' })
