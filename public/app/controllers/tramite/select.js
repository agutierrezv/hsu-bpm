angular.module('myApp').controller('SelectTramiteController', ['$http', '$scope', '$location', '$q', '$timeout', 'NavigationService', 'TramiteService', function($http, $scope, $location, $q, $timeout, NavigationService, TramiteService) {
